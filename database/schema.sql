...
CREATE TABLE country_travel_rates (
  ...
  agent_fee DECIMAL(10, 2) DEFAULT 0.00, -- Agent fee in EUR per trip
  company_fee DECIMAL(10, 2) DEFAULT 0.00, -- Company fee in EUR per trip
  additional_fee_percent DECIMAL(5, 2) DEFAULT 0.00, -- Additional fee as percentage of total trip cost
